...
class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        //Checkbox UnitCubeQuad
        this.gui.add(this.scene, 'displayUnitCubeQuad').name('UnitCube');

        //Checkbox Textures Filtering
        this.gui.add(this.scene, 'texturaFiltering').name('Textura Filter');
