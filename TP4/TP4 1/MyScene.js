...
class MyScene extends CGFscene {
    ...
    initLights() {
        this.setGlobalAmbientLight(this.ambientRed, this.ambientGreen, this.ambientBlue, 1.0);
    ...
    initMaterials() {
        ...
        // Madeira (4)
        this.materialMadeira = new CGFappearance(this);
        this.materialMadeira.setAmbient(0.55, 0.33, 0.2, 1.0);
        this.materialMadeira.setDiffuse(0.55, 0.33, 0.2, 1.0);
        this.materialMadeira.setSpecular(0.55,0.33, 0.2, 0.05);
        ...
        this.materials = [this.material1, this.material2, this.material3, this.customMaterial, this.materialMadeira];
