class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.waterTexture2 = new CGFtexture(this, "textures/waterMap.jpg");
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/1.vert", "shaders/1.frag"),
			new CGFshader(this.gl, "shaders/texture1.vert", "shaders/13.frag"),
		...
		this.testShaders[11].setUniformsValues({uSampler3: 0, uSampler4: 1});
	...
	display() {
		...
		//else
		//	this.setTexture(this.waterTexture);
