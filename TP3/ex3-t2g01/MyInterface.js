...
class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        // Ambient light sliders RGB
        var ambient = this.gui.addFolder('Ambient Light');
        ambient.add(this.scene, 'ambientRed', 0.00, 1.00).name("Ambient Red");
        ambient.add(this.scene, 'ambientGreen', 0.00, 1.00).name("Ambient Green");
        ambient.add(this.scene, 'ambientBlue', 0.00, 1.00).name("Ambient Blue");
