...
class MyTangram extends CGFobject {
	...
	display () {
       ...
       this.materialDiamond.setAmbient(0, 1, 0, 1.0);
       this.materialDiamond.setDiffuse(0, 1, 0, 1.0);
       this.materialDiamond.setSpecular(0, 1, 0, 0.8);
       ...
       this.materialTriangleBig2.setShininess(10.0);
        ...
        //if (this.displayTriangleSmall1)
            this.materialTriangleSmall1.apply();
            this.scene.pushMatrix();
        ...
        //if (this.displayTriangleSmall2)
            this.materialTriangleSmall2.apply();
            this.scene.pushMatrix();
            this.scene.translate(-0.6, -0.6, 0);
        ...
        //if (this.displayTriangleBig1)
            this.materialTriangleBig1.apply();
            this.scene.pushMatrix();
        ...
        //if (this.displayTriangleBig2)
            this.materialTriangleBig2.apply();
            this.scene.pushMatrix();
            this.scene.translate(-0.6, -0.6, 0);
